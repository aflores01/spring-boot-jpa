...
import com.learning.springboot.app.models.service.IUploadFileService;
...
public class ClienteController {
	...
	public String eliminar(@PathVariable(value = "id") Long id, RedirectAttributes flash) {
		if (id > 0) {
			...
			flash.addAttribute("info", "Cliente eliminado con éxito!");
			if (uploadService.delete(cliente.getFoto())) {
				flash.addAttribute("info", cliente.getFoto().concat(" Eliminada con éxito!"));
			}
